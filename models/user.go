...
//CreateOauth create or login a user from oauth login
func (u *User) CreateOauth(tx *pop.Connection) (*validate.Errors, error) {
	return tx.ValidateAndCreate(u)
}

// NickValidate checks if a nickname already exists
func (u *User) NickValidate(nick string, tx *pop.Connection) string {
